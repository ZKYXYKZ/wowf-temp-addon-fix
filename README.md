...
Put these file into your WoW : Forever root folder

<img width="626" height="262" alt="image" src="https://github.com/user-attachments/assets/8538185a-04fe-47ac-adb4-187987a87c87" />


Open "SavedVariablesBridge.ps1" and add every addons you need (see into /Interface/AddOns)

<img width="383" height="109" alt="image" src="https://github.com/user-attachments/assets/0abe73f2-11e1-44bb-bc5d-cdd0746c53d5" />


Save and run "RunBridge.cmd" then launch WoW : Forever



## REMEMBER TO RUN "RunBridge.cmd" BEFORE LAUNCH WORLD OF WARCRAFT : FOREVER
